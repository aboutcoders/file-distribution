...
class FileSystemDistributionClientIntegrationTest extends DistributionClientIntegrationTest
{
    protected function setUp()
    {
        ...
        $this->sourceFilesystem = new Filesystem();
        $this->sourceFilesystem->setType(FilesystemType::Filesystem);
        $this->sourceFilesystem->setPath($this->sourceFiles);
        $this->destinationFilesystem = new Filesystem();
        $this->destinationFilesystem->setType(FilesystemType::Filesystem);
        $this->destinationFilesystem->setPath($this->baseTestUrl);
    }
    ...
    public function testDistributeWithExistingFileThrowsException()
    {
        ...
        $this->subject->distribute($file, $this->destinationFilesystem);
    }
    ...
    public function testDeleteFileRemovesFile()
    {
        ...
        $file   = new File($fileToDelete, $fileToDelete, 14, $this->destinationFilesystem);
